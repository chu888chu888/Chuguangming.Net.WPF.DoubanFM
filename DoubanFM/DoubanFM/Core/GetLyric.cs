...
namespace DoubanFM
{
    public class GetLyric
    {
        ...
        public List<string> mvId = new List<string>();
        public string mvUrl = "";
        public Dictionary<TimeSpan, string> lyricDictionary = new Dictionary<TimeSpan, string>();
        public GetLyric(string keyword)
        {
            string lyricXml;
        ...
        public string Refresh(TimeSpan now)
        {
